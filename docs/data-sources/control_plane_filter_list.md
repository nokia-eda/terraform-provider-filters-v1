...
page_title: "filters-v1_control_plane_filter_list Data Source - filters-v1"
subcategory: ""
description: |-
  
---

# filters-v1_control_plane_filter_list (Data Source)
...
- `node_selectors` (List of String) Label selector used to select Toponodes on which to deploy the CPM filter.
...
- `ip_entry` (Attributes) IP Entry criteria and actions. (see [below for nested schema](#nestedatt--items--spec--entries--ip_entry))
- `mac_entry` (Attributes) MAC Entry criteria and actions. (see [below for nested schema](#nestedatt--items--spec--entries--mac_entry))
