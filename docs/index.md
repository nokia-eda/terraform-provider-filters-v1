---
page_title: "filters-v1 Provider"
---

# filters-v1 Provider

This provider is used to interact with the resources provided by the **filters-v1** application of the [Nokia EDA](https://docs.eda.dev) platform.
