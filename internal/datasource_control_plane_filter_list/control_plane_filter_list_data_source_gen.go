...
package datasource_control_plane_filter_list
...
func ControlPlaneFilterListDataSourceSchema(ctx context.Context) schema.Schema {
...
type ControlPlaneFilterListModel struct {
