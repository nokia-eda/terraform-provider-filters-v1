...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-filters/internal/resource_filter"
	"github.com/nokia/eda/apps/terraform-provider-filters/internal/tfutils"
)

const (
	create_rs_filter = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/filters"
	read_rs_filter   = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/filters/{name}"
	update_rs_filter = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/filters/{name}"
	delete_rs_filter = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/filters/{name}"
)

var (
	_ resource.Resource                = (*filterResource)(nil)
	_ resource.ResourceWithConfigure   = (*filterResource)(nil)
	_ resource.ResourceWithImportState = (*filterResource)(nil)
)
...
func (r *filterResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_filter, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_filter, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *filterResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_filter, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *filterResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_filter, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
