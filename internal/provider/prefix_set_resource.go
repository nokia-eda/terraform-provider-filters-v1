...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-filters/internal/resource_prefix_set"
	"github.com/nokia/eda/apps/terraform-provider-filters/internal/tfutils"
)

const (
	create_rs_prefixSet = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/prefixsets"
	read_rs_prefixSet   = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/prefixsets/{name}"
	update_rs_prefixSet = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/prefixsets/{name}"
	delete_rs_prefixSet = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/prefixsets/{name}"
)

var (
	_ resource.Resource                = (*prefixSetResource)(nil)
	_ resource.ResourceWithConfigure   = (*prefixSetResource)(nil)
	_ resource.ResourceWithImportState = (*prefixSetResource)(nil)
)
...
func (r *prefixSetResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
...
func (r *prefixSetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_prefixSet, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_prefixSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_prefixSet,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *prefixSetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_prefixSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *prefixSetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_prefixSet, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *prefixSetResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
