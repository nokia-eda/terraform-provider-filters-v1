...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-filters/internal/datasource_filter"
...
const read_ds_filter = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/filters/{name}"

var (
	_ datasource.DataSource              = (*filterDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*filterDataSource)(nil)
)
...
func (d *filterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_filter, map[string]string{
...
func (r *filterDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
