...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-filters/internal/datasource_prefix_set"
...
const read_ds_prefixSet = "/apps/filters.eda.nokia.com/v1/namespaces/{namespace}/prefixsets/{name}"
