...
func PrefixSetResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^PrefixSet$"), ""),
				},
				Default: stringdefault.StaticString("PrefixSet"),
			},
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "PrefixSetStatus defines the observed state of PrefixSet",
			},
		},
	}
}
